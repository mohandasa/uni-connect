	...
	<div class="row">
		...
		<div class="col-md-9">
			<div class="widget">
				...
				<div class="innerAll bg-gray border-bottom">
					...
					<h4 class="margin-none">General Discussion</h4>
								...
								<li class="media">
								    ...
								    <div class="media-body">
									    <div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Getting Started</a></h4>
									  		<div class="clearfix"></div>
						...
						<div class="col-sm-6 col-xs-8">
							<ul class="media-list margin-none">
								<li class="media">
								    ...
								    <div class="media-body">
									    <div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Requirements</a></h4>
									  		<div class="clearfix"></div>
									    	<small class="margin-none">Topic information goes here</small> 
								    	</div>
						...
						<div class="col-sm-6 col-xs-8">
							<ul class="media-list margin-none">
								<li class="media">
								    ...
								    <div class="media-body">
									    <div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Common Questions</a></h4>
									  		<div class="clearfix"></div>
									    	<small class="margin-none">Topic information goes here</small> 
								    	</div>
			...
			<div class="widget">
				...
				<div class="innerAll bg-gray border-bottom">
					<a href="#" class="btn btn-xs btn-inverse pull-right"><i class="fa fa-plus fa-fw"></i> New Topic</a>
					<h4 class="margin-none">Customization</h4>
					<div class="clearfix"></div>
				</div>
				<!-- End Category Heading -->
				<!-- Category Listing -->
						...
						<div class="col-sm-6 col-xs-8">
							<ul class="media-list margin-none">
								<li class="media">
								    ...
								    <div class="media-body">
								    	<div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Changing Skin</a></h4>
									  		<div class="clearfix"></div>
									    	<small class="margin-none">Topic information goes here</small> 
								    	</div>
								    </div>
						...
						<div class="col-sm-6 col-xs-8">
							<ul class="media-list margin-none">
								<li class="media">
								    ...
								    <div class="media-body">
								    	<div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Sidebar Type</a></h4>
									  		<div class="clearfix"></div>
									    	<small class="margin-none">Topic information goes here</small> 
								    	</div>
								    </div>
						...
						<div class="col-sm-6 col-xs-8">
							<ul class="media-list margin-none">
								<li class="media">
								    ...
								    <div class="media-body">
								    	<div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Common</a></h4>
									  		<div class="clearfix"></div>
									    	<small class="margin-none">Topic information goes here</small> 
								    	</div>
								    </div>
						...
						<div class="col-sm-6 col-xs-8">
							<ul class="media-list margin-none">
								<li class="media">
								    ...
								    <div class="media-body">
								    	<div class="innerAll half">
									    	<h4 class="margin-none"><a href="" class="media-heading strong text-primary">Including New Elements </a></h4>
									  		<div class="clearfix"></div>
									    	<small class="margin-none">Topic information goes here</small> 
								    	</div>
								    </div>
		...
		<div class="col-md-3">
			...
			<div class="widget">
				...
				<!-- Heading -->
				<h4 class="innerAll margin-bottom-none bg-primary"><i class="fa fa-user fa-fw"></i> Recent Members</h4>
			
				<!-- Listing -->
												<div class="border-bottom bg-gray-hover innerAll half">
					<div class="media">
						<a href="" class="pull-left innerAll half">
							<i class="fa fa-user fa-2x text-muted"></i>
						</a>
						<div class="media-body innerTB half">
							<a href="" class="strong text-primary">John</a>
					...
					<div class="media">
						...
						<div class="media-body innerTB half">
							<a href="" class="strong text-primary">mosaicpro</a>
							<small class="clearfix">on 16 Jan 2014</small>
						</div>
					</div>
				</div>
					...
					<div class="media">
						...
						<div class="media-body innerTB half">
							<a href="" class="strong text-primary">Jane</a>
							<small class="clearfix">on 16 Jan 2014</small>
						</div>
					</div>
				</div>
			...
			<div class="widget">
				...
				<!-- Heading -->
				<h4 class="innerAll margin-bottom-none bg-primary"><i class="fa fa-refresh fa-fw"></i> Latest Posts</h4>

				<!-- Listing -->
								<div class="bg-gray-hover innerAll half border-bottom">
			    	<div class="innerAll half">
			    		<h5 class="innerB half margin-none"><a href="#" class="text-primary strong">How do you guys change navbar into white?</a></h5>
