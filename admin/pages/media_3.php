	        ...
	        <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-3" style="height: 1px;">
				<div class="padding-none">
					<ul class="display-block">
						<li><a class="" href="<?php echo getURL(array('page'=>'timeline_3')); ?>"><i class="fa fa-fw icon-road-sign"></i> <span>Timeline</span></a></li>
						<li class="active"><a href="<?php echo getURL(array('page'=>'media_3')); ?>"><i class="fa fa-fw icon-flip-camera"></i> <span>Photos</span></a></li>
 ...
 -->
				...
				<div class="widget-body">
					...
					<div class="tabsbar">
						<ul>
							...
							<li class="glyphicons circle_plus tab-stacked"><a href="<?php echo getURL(array('page'=>'form_elements')); ?>"><i></i> <span>Add Photos</span></a></li>
					...
					<div class="gallery">
						<ul class="row">
							<?php 
								$result = mysql_query("SELECT * FROM photos_try");
								while($row = mysql_fetch_array($result))
								{
									echo '<li class="col-md-2">';
									echo '<a class="thumb no-ajaxify" href="'.$row['location'].'" data-gallery="gallery-3">';
									echo '<img src="'.$row['location'].'" alt="'.$row['caption'].'" class="img-responsive" />';
									echo '</a>';
									echo '</li>';
								}
							?>
	...
	<div class="widget-body padding-none">
		<ul class="list-group list-group-1 borders-none margin-none">
			...
			<div class="widget">
	<h5 class="innerAll margin-none border-bottom bg-gray">Recent Uploads</h5>
	<div class="widget-body padding-none">
