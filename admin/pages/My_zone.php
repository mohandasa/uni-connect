...
<!-- 		<nav class="navbar widget-head padding-none margin-none" role="navigation">
	        ...
	        <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-3" style="height: 1px;">
				<div class="padding-none">
					<ul class="display-block">
						<li class="active"><a class="" href="<?php echo getURL(array('page'=>'My_zone')); ?>"><i class="fa fa-fw icon-road-sign"></i> <span>Timeline</span></a></li>
 ...
 -->
            ...
            <div class="innerB">
				...
				<button class="btn btn-default filter active" data-filter="mixit-filter-2">My Zone</button>
