		...
		<div class="col-md-3">
			...
			<div class="widget">
				...
				<ul class="list-group list-group-1 margin-none borders-none">
					<li class="list-group-item animated fadeInUp"><a href="#"><span class="badge pull-right badge-default hidden-md">15</span> Category #1</a></li>
					<li class="list-group-item animated fadeInUp"><a href="#"><span class="badge pull-right badge-default hidden-md">10</span> Second Category</a></li>
					<li class="list-group-item animated fadeInUp"><a href="#"><span class="badge pull-right badge-default hidden-md">10</span> Third Category</a></li>
					<li class="list-group-item border-bottom-none animated fadeInUp"><a href="#"><span class="badge pull-right badge-default hidden-md">10</span> Forth Category</a></li>
				</ul>
			</div>
			<div class="widget">

				<h5 class="innerAll bg-gray border-bottom margin-bottom-none">Filter by</h5>
				<form role="form">
					<div class="innerAll inner-2x">
						<div class="form-group">
					  		<div class="input-group">
								<span class="input-group-addon bg-gray"><i class="fa fa-question-circle text-faded"></i></span>
				  	...
				  	<div class="text-center border-top innerTB"><a href="<?php echo getURL(array('page'=>'support_questions')); ?>" class="btn btn-primary"><i class="fa fa-fw fa-search"></i> Search</a></div>
				</form>
			</div>
		...
		<div class="col-md-9">
			...
			<div class="widget">
				...
				<div class="widget-head">
					<h4 class="heading">Questions and Answers</h4>
				</div>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <a class="pull-left" href="<?php echo getURL(array('page'=>'support_answers')); ?>">
												      													      	<img class="media-object" src="../assets/images/people/50/1.jpg" alt="..." >
												      													    </a>
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Finding the right team?</a>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">What makes Coral such an outstanding Template?</a>
											...
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <a class="pull-left" href="<?php echo getURL(array('page'=>'support_answers')); ?>">
											      			...
											      			<i class="icon-blood-sample fa-2x"></i>
											      		</span>
											  															    </a>
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">What else will you guys come up with?</a>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">How many pages does this have?</a>
												  														  		<label class="label label-success"><i class="icon-checkmark-thick fa fa-fw"></i> Answered</label> 
												  														    	<div class="clearfix"></div>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Getting to know Coral</a>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Is it right for my project?</a>
												  														  		<label class="label label-success"><i class="icon-checkmark-thick fa fa-fw"></i> Answered</label> 
												  														    	<div class="clearfix"></div>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">About the new Email page</a>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Social Page customization</a>
												  														  		<label class="label label-success"><i class="icon-checkmark-thick fa fa-fw"></i> Answered</label> 
												  														    	<div class="clearfix"></div>
												    	<small>posted by <a href="">John Carsten</a> <i class="fa fa-fw icon-time-clock"></i> 12:51 AM</small>
												    </div>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Personal Assistant</a>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Developer</a>
												  														  		<label class="label label-success"><i class="icon-checkmark-thick fa fa-fw"></i> Answered</label> 
												  														    	<div class="clearfix"></div>
												    	<small>posted by <a href="">Bogdan Laza</a> <i class="fa fa-fw icon-time-clock"></i> 12:51 AM</small>
												    </div>
										...
										<div class="col-sm-10">
											<ul class="media-list margin-none">
												<li class="media">
												    ...
												    <div class="media-body innerAll half">
												    	<a href="<?php echo getURL(array('page'=>'support_answers')); ?>" class="media-heading">Project Manager</a>
