...
<!-- 		<nav class="navbar widget-head padding-none margin-none" role="navigation">
 ...
 -->
			...
			<div class="media">
            <div class="innerB">
				<button class="btn btn-default filter " data-filter="mixit-filter-1">Union Bank</button>
				<button class="btn btn-default filter" data-filter="mixit-filter-2">My Zone</button>
				<button class="btn btn-default filter active" data-filter="all">My Region</button>
