	...
	public function makeMenu() 
	{
		...
		foreach ($this->menu as $menu) {
			...
			<li class="<?php echo implode(" ", $menuClass); ?>">
				...
				if (isset($menu['page']) || isset($menu['href']) || isset($menu['onClick'])): ?>
				<a <?php if (isset($menu['onClick'])): ?>href="" ng-click="<?php echo $menu['onClick']; ?>"<?php endif; ?> <?php if (!isset($menu['onClick'])): ?>href="<?php echo $href; ?>"<?php endif; ?><?php if ($menuCollapse): ?> data-toggle="collapse"<?php endif; ?><?php if (isset($menu['link_class'])): ?> class="<?php echo $menu['link_class']; ?>"<?php endif; ?>>
				<?php endif; ?>
